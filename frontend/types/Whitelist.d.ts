...
interface WhitelistInterface extends ethers.utils.Interface {
  functions: {
    ...
    "addAddress(address,uint256,uint256)": FunctionFragment;
    "getRoleAdmin(bytes32)": FunctionFragment;
    "grantRole(bytes32,address)": FunctionFragment;
    "hasRole(bytes32,address)": FunctionFragment;
    "isWhitelisted(address,uint256)": FunctionFragment;
    "removeAddress(address,uint256)": FunctionFragment;
    "renounceRole(bytes32,address)": FunctionFragment;
    "revokeRole(bytes32,address)": FunctionFragment;
    "supportsInterface(bytes4)": FunctionFragment;
    "whitelist(uint256,uint256)": FunctionFragment;
  };
...
export class Whitelist extends BaseContract {
  ...
  functions: {
    ...
    whitelist(
      ...
      [string, BigNumber] & { contractAddress: string; minBalance: BigNumber }
    >;
  };
