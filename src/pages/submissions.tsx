        ...
        <div className='submissions-page__main-left'>
          <div className='submissions-page__guidelines-group'>
            ...
            <p className='submissions-page__guidelines-text'>
              SAGE is a highly curated platform, we take the application process very seriously
              that’s the reason we changed the way how artist can apply to be a creator on the SAGE
              platform. Artist should present their works in a pdf format and submit it below. We
              would like you to <span className='submissions-page__emphasis'>take your time</span>{' '}
              to present yourself and your creations.
            </p>
          </div>
          <div className='submissions-page__guidelines-group'>
            <h1 className='submissions-page__guidelines-header'>Standards</h1>
            <p className='submissions-page__guidelines-text'>
              When it comes to digital art, we provide specific guidelines regarding technical
              standards and image resolution. Artists’ works must meet these requirements. We do
              this not only to ensure that the quality of the work is up to par but also to make
              certain that the work will meet our expectations of how the featured art will look—and
              be presented—in an exhibition outside the web. These standards are currently what we
              look for when checking artists’ applications. In terms of animation or 3D-rendering
              artwork, we seek a quality standard of 4k and up.
            </p>
          </div>
