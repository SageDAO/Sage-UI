            ...
            >
              ...
              <div className='artists-page__item-content'>
                ...
                <p className='artists-page__item-content-description'>
                  ...
                  AND PROGRAMMER. THE IDENTITY OF PAK IS UNKNOWN AND SOME SPECULATE THAT IT MAY BE A
                  TEAM. PAK IS KNOWN FOR CREATING THE CURATION PLATFORM ARCHILLECT, AN INTERNET
                  BOT WHICH RESHARES MEDIA BASED ON USER INTERACTIONS WITH CONTENT HOSTED ON VARIOUS
                  SOCIAL PLATFORMS AND FOR LAUNCHING A PLATFORM FOR BURNING (PERMANENTLY REMOVING
