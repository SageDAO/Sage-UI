...
export default function Socials() {
  return (
    <div className='socials'>
      <a target='_blank' href='https://discord.com/invite/sageweb3'>
        <Discord className='socials__icon' />
      </a>
      <a target='_blank' href='https://twitter.com/SAGE_WEB3'>
        <Twitter className='socials__icon' />
      </a>
      <a target='_blank' href='https://medium.com/@SAGE_WEB3'>
      ...
      <a target='_blank' href='https://coinmarketcap.com/currencies/ash/'>
