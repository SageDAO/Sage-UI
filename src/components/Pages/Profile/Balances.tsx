...
export default function Balances() {
  ...
  const tooltip = 'For each 100 ASH you hold,<br/>you will get 25 PIXEL per day<br/>(limited to 250 PIXEL/day)';
  return (
    <div className='profile-page__balances'>
      <ReactTooltip id='main' place={'top'} type={'light'} effect={'solid'} multiline={true} />
      <div className='profile-page__balances-token' style={{ width: '50%', textAlign: 'center'}}>
      ...
      <div className='profile-page__balances-points' style={{ textAlign: 'center'}}>
